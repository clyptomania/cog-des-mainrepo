...
namespace Tobii.Research.Unity
{
    public sealed class VRGazeData : IVRGazeData
    {
        ...
        internal VRGazeData(HMDGazeDataEventArgs originalGaze, EyeTrackerOriginPose pose)
        {
            ...
            Vector3 eyeTrackerOrigin_position = pose.Position;
            Quaternion eyeTrackerOrigin_rotation = pose.Rotation;

            Left = new VRGazeDataEye(originalGaze.LeftEye, eyeTrackerOrigin_position, eyeTrackerOrigin_rotation);
            Right = new VRGazeDataEye(originalGaze.RightEye, eyeTrackerOrigin_position, eyeTrackerOrigin_rotation);
            ...
            CombinedGazeRayWorld = new Ray(combinedOrigin - eyeTrackerOrigin_position, combinedDirection - eyeTrackerOrigin_rotation.eulerAngles);
    ...
    public sealed class VRGazeDataEye : IVRGazeDataEye
    {
        ...
        internal VRGazeDataEye(HMDEyeData eye, Vector3 position, Quaternion rotation)
        {
            ...
            GazeRayWorld = new Ray(GazeOrigin - position, GazeDirection - rotation.eulerAngles);
