...
namespace Tobii.Research.Unity
{
    public class VREyeTracker : EyeTrackerBase
    {
        ...
        [Range(0f, 70f)]
        [SerializeField]
        public float _hmdPosePredictionOffset = 34;
        ...
        /// </summary>
        public PoseList _eyeTrackerOriginPoses = new PoseList(100);
...
#if USE_OPENVR_BINDINGS
        public TrackedDevicePose_t[] poseArray = new TrackedDevicePose_t[OpenVR.k_unMaxTrackedDeviceCount];
#endif
...
//                    Debug.Log("Failed to get historical pose");
        ...
        // public delegate void HMDGazeDataReceivedCallbackDel (object sender, HMDGazeDataEventArgs eventArgs);
        // public HMDGazeDataReceivedCallbackDel HMDGazeDataReceivedCallback;

        public void HMDGazeDataReceivedCallback(object sender, HMDGazeDataEventArgs eventArgs)
